...
public final class Util {
    ...
    static final String EXTRA_FORCE_ABOUT = "de.spiritcroc.darkcroc.substratum.force_about";

    static final String SUBSTRATUM_PACKAGE_NAME = "projekt.substratum";
    static final String THEME_PACKAGE_NAME = Util.class.getPackage().getName();
